  ...
  constructor() {
    super({
      ...
      void main() {
        ...
        vec3 pink = vec3(1.0, 0.412, 0.706); // #FF69B4 (Hot Pink)
        vec3 lilac = vec3(0.718, 0.580, 0.957); // #B794F4
        vec3 violet = vec3(0.541, 0.169, 0.886); // #8A2BE2
        
        float colorMix1 = smoothstep(-0.5, 0.0, vPosY); // Pink to Lilac transition
        float colorMix2 = smoothstep(0.0, 1.0, vDistance); // Lilac to Violet transition
        
        vec3 pinkToLilac = mix(pink, lilac, colorMix1);
        vec3 particleColor = mix(pinkToLilac, violet, colorMix2);
